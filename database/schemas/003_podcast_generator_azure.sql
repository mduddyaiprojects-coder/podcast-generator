-- Podcast Generator Database Schema for Azure PostgreSQL
-- This creates the complete schema matching the data model specification
-- Database: podcast_generator

-- Note: Azure PostgreSQL doesn't allow uuid-ossp extension
-- We'll use gen_random_uuid() instead which is available by default
...
-- Insert default global feed (with a placeholder voice ID to satisfy constraint)
INSERT INTO global_feed (id, title, description, author, category, admin_email, tts_provider, tts_voice_id) 
VALUES (
