import type { AddDataStoreColumnDto, CreateDataStoreDto, ListDataStoreContentQueryDto, MoveDataStoreColumnDto, DataStoreListOptions, UpsertDataStoreRowDto, UpdateDataStoreDto, UpdateDataTableRowDto } from '@n8n/api-types';
import { Logger } from '@n8n/backend-common';
import type { DataStoreColumnJsType, DataStoreRowReturn, DataStoreRows } from 'n8n-workflow';
...
export declare class DataStoreService {
    ...
    insertRows<T extends boolean | undefined>(dataStoreId: string, projectId: string, rows: DataStoreRows, returnData?: T): Promise<Array<T extends true ? DataStoreRowReturn : Pick<DataStoreRowReturn, 'id'>>>;
    upsertRow<T extends boolean | undefined>(dataStoreId: string, projectId: string, dto: Omit<UpsertDataStoreRowDto, 'returnData'>, returnData?: T): Promise<T extends true ? DataStoreRowReturn[] : true>;
