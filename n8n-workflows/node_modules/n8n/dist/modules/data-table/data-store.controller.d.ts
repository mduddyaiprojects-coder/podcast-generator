import { AddDataStoreRowsDto, AddDataStoreColumnDto, CreateDataStoreDto, DeleteDataStoreRowsQueryDto, ListDataStoreContentQueryDto, ListDataStoreQueryDto, MoveDataStoreColumnDto, UpdateDataStoreDto, UpdateDataTableRowDto, UpsertDataStoreRowDto } from '@n8n/api-types';
...
export declare class DataStoreController {
    ...
    appendDataStoreRows<T extends boolean | undefined>(req: AuthenticatedRequest<{
        projectId: string;
